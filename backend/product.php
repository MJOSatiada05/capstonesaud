            ...
            <div class="col-12 col-xl-2">
                <div
                    ...
                    <ul class="nav nav-pills flex-column mb-auto w-100">
                        ...
                        <li class="nav-item">
                            <a href="preorder.php" class="nav-link link-light">
                                <i class="bx bxl-product-hunt me-2"></i>Pre Order
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        if(isset($_POST['submit'])) {
            ...
            if ($uploadOk == 0) {
                ...
                if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
                    $sql = "INSERT INTO `product_list` (`image`, `title`, `description`, `price`, `quantity`, `categories`, `timestamp`) 
