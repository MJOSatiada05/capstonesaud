...
<body>
    ...
    <?php
        ...
        $sql = "SELECT id, image, title, description, price, quantity, harvest, timestamp FROM product_list $whereClause";
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Harvest Time: <?php echo $product['harvest']; ?></p>
